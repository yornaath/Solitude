  ...
  $(function() {
    require.ready(function() {
      ...
      var twitterFeedController = new TwitterFeedController();
			...
			$('#oops').click(function(){
				Gears.showPopup("<div><h1>Crap.. :/</h1><p>No worries tough! Leave me a mail at <span style='color: rgba(211/100/59, 0.6);'>andtan@cygnus-group.net</span> or leave a issue on the <a href='https://github.com/andtan/Solitude/issues' target='_blank'>github page</a>. Your contribution to making the app better is much appreciated!</p></div>");
			});
      //END MAIN CODE
    });
  });
