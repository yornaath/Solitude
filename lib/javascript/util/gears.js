...
function($) {
  ...
  var Gears = {
		showIntroduction: function(){
			...
			$('#introduction').html("<div id='closeIntro' style='float: right; cursor: pointer;'>Close</div><iframe style='border: 0px solid gray; width: 100%; height: 245px;' src='introduction.html'/>");
